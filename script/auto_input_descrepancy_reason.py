...
PATH_REASON_INPUT_IN = const.PATH_REASON_INPUT
PATH_REASON_INPUT_OUT = const.PATH_REASON_INPUT # TODO: the file definition is needed
...
if __name__ == "__main__":
    ...
    is_needed_reason_input_in = os.path.isfile(PATH_REASON_INPUT_IN)
    is_needed_reason_input_out = os.path.isfile(PATH_REASON_INPUT_OUT)

    playwright = sync_playwright().start()

    user_data_dir = Path("reason_input")
